...
Partial Class UpdateUser
    ...
    Private Sub InitializeComponent()
        ...
        btnSave.Font = New Font("Century Gothic", 11.25F, FontStyle.Regular, GraphicsUnit.Point)
        btnSave.ForeColor = Color.Black
        btnSave.Location = New Point(123, 315)
        btnSave.Name = "btnSave"
        btnSave.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        btnSave.Size = New Size(128, 37)
        btnSave.TabIndex = 30
        btnSave.Text = "Save"
        ' 
        ' Label4
        ...
        Label4.Location = New Point(47, 253)
        Label4.Name = "Label4"
        ...
        txtPassword.Location = New Point(47, 273)
        txtPassword.Name = "txtPassword"
        txtPassword.PasswordChar = "*"c
        txtPassword.PlaceholderText = ""
        txtPassword.SelectedText = ""
        txtPassword.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        txtPassword.Size = New Size(280, 36)
        txtPassword.TabIndex = 27
        ' 
        ' txtPosition
        ' 
        txtPosition.CustomizableEdges = CustomizableEdges5
        txtPosition.DefaultText = ""
        txtPosition.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        txtPosition.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        txtPosition.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtPosition.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtPosition.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtPosition.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        txtPosition.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtPosition.Location = New Point(47, 214)
        txtPosition.Name = "txtPosition"
        txtPosition.PasswordChar = ChrW(0)
        txtPosition.PlaceholderText = ""
        txtPosition.SelectedText = ""
        txtPosition.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        txtPosition.Size = New Size(280, 36)
        txtPosition.TabIndex = 26
        ' 
        ' Label3
        ' 
        ...
        txtName.Location = New Point(47, 98)
        ...
        Guna2HtmlLabel8.Font = New Font("Century Gothic", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        Guna2HtmlLabel8.Location = New Point(12, 12)
        Guna2HtmlLabel8.Name = "Guna2HtmlLabel8"
        Guna2HtmlLabel8.Size = New Size(117, 25)
        Guna2HtmlLabel8.TabIndex = 2
        Guna2HtmlLabel8.Text = "Update User"
        ' 
        ' Guna2ControlBox1
        ' 
        ...
        Guna2ControlBox1.Location = New Point(331, 3)
        ...
        Guna2HtmlLabel1.Location = New Point(-279, 11)
        Guna2HtmlLabel1.Name = "Guna2HtmlLabel1"
        Guna2HtmlLabel1.Size = New Size(89, 25)
        Guna2HtmlLabel1.TabIndex = 1
        Guna2HtmlLabel1.Text = "Add Item"
        ' 
        ' UpdateUser
        ' 
