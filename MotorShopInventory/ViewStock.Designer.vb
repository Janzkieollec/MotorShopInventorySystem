...
Partial Class ViewStock
    ...
    Private Sub InitializeComponent()
        ...
        viewId = New DataGridViewTextBoxColumn()
        ...
        inventoryDatgrid.Columns.AddRange(New DataGridViewColumn() {viewId, ID, product_name, Brand, description, dated, statuss, Stock})
        ...
        Guna2ControlBox1.TabIndex = 32
        ' 
        ' viewId
        ' 
        viewId.DataPropertyName = "stock_id"
        viewId.HeaderText = "viewId"
        viewId.Name = "viewId"
        viewId.ReadOnly = True
        viewId.Visible = False
        ' 
        ' ID
        ' 
    ...
    Friend WithEvents viewId As DataGridViewTextBoxColumn
